...
function minSubArrayLen(nums, sum) {
  let total = 0;
    ...
    while (start < nums.length) {
      // if current window doesn't add up to the given sum then move the window to right i.e end will inc
        ...
        // current total less than required total but we reach the end, need this or else we'll be
        // in an infinite loop
        else {
            break;
        }
